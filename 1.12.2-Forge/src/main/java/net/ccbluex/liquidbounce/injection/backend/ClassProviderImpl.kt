...
object ClassProviderImpl : IClassProvider {
    ...
    override fun createCPacketPlayerBlockPlacement(hand: WEnumHand): ICPacketPlayerTryToUseItem = CPacketPlayerTryUseItemImpl(CPacketPlayerTryUseItem(EnumHand.MAIN_HAND))
    ...
    override fun isC0F(obj: Any?): Boolean = obj is PacketImpl<*> && obj.wrapped is CPacketConfirmTransaction
