...
open class BoolValue(name: String, value: Boolean) : Value<Boolean>(name, value) {
    ...
    fun toggle() {
        value = java.lang.String.valueOf(value).toBoolean()
    }
...
open class ListValue(name: String, val values: Array<String>, value: String) : Value<String>(name, value) {
    ...
    fun equals(obj: String?, igniteCase: Boolean = false): Boolean {
        return value.equals(obj, igniteCase)
    }

    fun getModeGet(i: Int): String {
        return values[i]
    }
