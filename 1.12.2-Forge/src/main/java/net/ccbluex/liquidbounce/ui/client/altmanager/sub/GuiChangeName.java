...
public class GuiChangeName extends WrappedGuiScreen {
    ...
    public void initGui() {
        ...
        name = classProvider.createGuiTextField(2, Fonts.roboto40, representedScreen.getWidth() / 2 - 100, 60, 200, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.roboto40.drawCenteredString("Change Name", representedScreen.getWidth() / 2.0f, 34, 0xffffff);
        Fonts.roboto40.drawCenteredString(status == null ? "" : status, representedScreen.getWidth() / 2.0f, representedScreen.getHeight() / 4.0f + 84, 0xffffff);
        name.drawTextBox();

        if (name.getText().isEmpty() && !name.isFocused())
            Fonts.roboto40.drawCenteredString("§7Username", representedScreen.getWidth() / 2.0f - 74, 66, 0xffffff);
