...
class GuiDonatorCape(private val prevGui: GuiAltManager) : WrappedGuiScreen() {
    ...
    override fun initGui() {
        ...
        transferCodeField = classProvider.createGuiPasswordField(666, Fonts.roboto40, representedScreen.width / 2 - 100, 80, 200, 20)
    ...
    override fun drawScreen(mouseX : Int, mouseY : Int, partialTicks : Float) {
        ...
        Fonts.roboto35.drawCenteredString("Donator Cape", representedScreen.width / 2.0f, 36.0f, 0xffffff)
        Fonts.roboto35.drawCenteredString(status, representedScreen.width / 2.0f, representedScreen.height / 4.0f + 80, 0xffffff)

        // Draw fields
        transferCodeField.drawTextBox()

        Fonts.roboto40.drawCenteredString("§7Transfer Code:", representedScreen.width / 2.0f - 65, 66.0f, 0xffffff)
