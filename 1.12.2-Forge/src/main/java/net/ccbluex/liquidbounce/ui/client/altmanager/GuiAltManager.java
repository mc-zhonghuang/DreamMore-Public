...
public class GuiAltManager extends WrappedGuiScreen {
    ...
    public void initGui() {
        ...
        searchField = classProvider.createGuiTextField(2, Fonts.roboto40, representedScreen.getWidth() - textFieldWidth - 10, 10, textFieldWidth, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.roboto40.drawCenteredString("AltManager", representedScreen.getWidth() / 2.0f, 6, 0xffffff);
        Fonts.roboto35.drawCenteredString(this.searchField.getText().isEmpty() ? (LiquidBounce.fileManager.accountsConfig.getAccounts().size() + " Alts") : this.altsList.accounts.size() + " Search Results", representedScreen.getWidth() / 2.0f, 18, 0xffffff);
        Fonts.roboto35.drawCenteredString(status, representedScreen.getWidth() / 2.0f, 32, 0xffffff);
        Fonts.roboto35.drawStringWithShadow("§7User: §a" + (mc.getSession().getUsername()), 6, 6, 0xffffff);
        Fonts.roboto35.drawStringWithShadow("§7Type: §a" + "Cracked", 6, 15, 0xffffff);
    ...
    private class GuiList extends WrappedGuiSlot {
        ...
        public void drawSlot(int id, int x, int y, int var4, int var5, int var6) {
            ...
            Fonts.roboto40.drawCenteredString(minecraftAccount.getAccountName() == null ? minecraftAccount.getName() : minecraftAccount.getAccountName(), (representedScreen.getWidth() / 2), y + 2, Color.WHITE.getRGB(), true);
            Fonts.roboto40.drawCenteredString(minecraftAccount.isCracked() ? "Cracked" : (minecraftAccount.getAccountName() == null ? "Premium" : minecraftAccount.getName()), (representedScreen.getWidth() / 2), y + 15, minecraftAccount.isCracked() ? Color.GRAY.getRGB() : (minecraftAccount.getAccountName() == null ? Color.GREEN.getRGB() : Color.LIGHT_GRAY.getRGB()), true);
        }
