...
public class GradientUtil implements Utils {
    ...
    private static final ShaderUtil gradientMaskShader = new ShaderUtil("more/Shaderss/gradientmask.frag");
    private static final ShaderUtil gradientShader = new ShaderUtil("more/Shaderss/gradient.frag");
