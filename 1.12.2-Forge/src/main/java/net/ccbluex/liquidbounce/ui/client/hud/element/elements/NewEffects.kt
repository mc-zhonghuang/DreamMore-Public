...
class NewEffects(x: Double =97.0, y: Double = 141.0, scale: Float = 1F) : Element() {
    ...
    override fun drawElement(): Border {
        ...
        for (potionEffect in Objects.requireNonNull(mc.thePlayer)!!.activePotionEffects) {
            ...
            val namewith2 =
                Fonts.font30.getStringWidth(name+" "+ intToRomanByGreedy(potionEffect.amplifier + 1))
            namewith =
                Fonts.font30.getStringWidth(name+" "+ intToRomanByGreedy(potionEffect.amplifier + 1)).toFloat()
            ...
            Fonts.font30.drawString(
                ...
                15f,
                -(posY - Fonts.font30.fontHeight),
                -1
            )

            Fonts.font30.drawString(potionEffect.getDurationString(), 93f, -(posY - 9.76f), Color(0, 157, 0,210).rgb)
            y -= 35
        }
        ...
        Fonts.nbicon20.drawString("q",34,-2,Color(255, 255, 255).rgb)
        Fonts.font35.drawString("Potions",48,-3,Color(255,255,255,255).rgb)
