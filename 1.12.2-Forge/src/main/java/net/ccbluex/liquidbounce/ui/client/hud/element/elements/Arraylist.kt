...
import net.ccbluex.liquidbounce.rename.modules.misc.blur.ArrayBlurUtils
...
class Arraylist(x: Double = 1.0, y: Double = 2.0, scale: Float = 1F,
    ...
    private val colorModeValue = ListValue("Color", arrayOf("Custom", "Random", "Sky", "CRainbow", "LiquidSlowly", "Fade", "DoubleColor", "CustomHUD","Gradinet"), "DoubleColor")
    ...
    private val shadowColorMode = ListValue("Shadow-Color", arrayOf("Background", "Text", "Custom", "Round", "Gradient"), "Background")
    ...
    private val backgroundWithValue = IntegerValue("Background-Width", 2, 0, 12)
    ...
    var fontRenderer = Fonts.tenacitybold40
...
//bg
        ...
        val alpha= Color(CustomColor.r2.get(),CustomColor.g2.get(),CustomColor.b2.get()).rgb
                ...
                when (vAnimation.get()) {
                    "LiquidSense" -> {
                        ...
                        val color4 = RenderUtils.getGradientOffset(
                            Color(CustomColor.r.get(), CustomColor.g.get(), CustomColor.b.get(), backgroundColorAlphaValue.get()),
                            Color(CustomColor.r2.get(), CustomColor.g2.get(), CustomColor.b2.get(), backgroundColorAlphaValue.get()),
                            (kotlin.math.abs(
                            ...
                            // Background
                                when (shadowColorMode.get().toLowerCase()) {
                                    ...
                                    "gradient" -> {
                                        ...
                                        RenderUtils.ArrayListBGGradient(
                                                (xPos - if (rectRightValue.get().equals("right", true)) 2 + backgroundWithValue.get() else 0 + backgroundWithValue.get()).toDouble(),
                                                (module.higt - if (index == 0) 1 else 0).toDouble(),
                                                if (rectRightValue.get().equals("right", true)) (-2F).toDouble() else 1.0,
                                                (module.higt + textHeight).toDouble(), when {
                                    ...
                                    "round" -> {
                                        ...
                                        var FadeColor = ColorUtils.fade(Color(colorRedValue.get(), colorGreenValue.get(), colorBlueValue.get(), colorAlphaValue.get()), index * fadeDistanceValue.get(), 100).rgb
                                        counter[0] = counter[0] - 1
                                        val color3 = Color(CustomColor.r.get(), CustomColor.g.get(), CustomColor.b.get()).rgb
                                        val color4 = RenderUtils.getGradientOffset(
                                                Color(CustomColor.r.get(), CustomColor.g.get(), CustomColor.b.get(), backgroundColorAlphaValue.get()),
                                                Color(CustomColor.r2.get(), CustomColor.g2.get(), CustomColor.b2.get(), backgroundColorAlphaValue.get()),
                                                (kotlin.math.abs(
                                        ...
                                        RenderUtils.ArrayListBGGradient(
                                            ...
                                            colorMode.equals("Fade", ignoreCase = true) -> FadeColor
                                            colorMode.equals("DoubleColor", ignoreCase = true) -> color4
                                            colorMode.equals("CustomHUD", ignoreCase = true) -> color3
                                            colorMode.equals("Gradinet", true) -> RenderUtils.getGradientOffset(Color(textRed.get(), textGreen.get(), textBlue.get()), Color(textRed2.get(), textGreen2.get(), textBlue2.get()), index * fadeOffset.get().toDouble()).rgb
                                            else -> customColor
                                        },alpha)
                                    }
