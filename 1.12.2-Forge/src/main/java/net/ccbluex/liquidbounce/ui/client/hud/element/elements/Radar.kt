...
class Radar(x: Double = 5.0, y: Double = 130.0) : Element(x, y) {
    ...
    override fun drawElement(): Border? {
        ...
        RoundedUtil.drawGradientRound(0f,0f,size,size,CustomColor.ra.get(), ColorUtil.applyOpacity(gradientColor4, .85f), gradientColor1, gradientColor3, gradientColor2)
