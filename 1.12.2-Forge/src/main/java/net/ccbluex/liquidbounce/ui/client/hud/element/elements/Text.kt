...
class Text(x: Double = 10.0, y: Double = 10.0, scale: Float = 1F,
    ...
    companion object {
        ...
        fun defaultClient(): Text {
            ...
            text.displayString.set( "More | Fps:%fps% | %serverip%")
    ...
    private var fontValue = FontValue("Font", Fonts.productSans40)
    ...
    private val display: String
        get() {
            val textContent = if (displayString.get().isEmpty() && !editMode)
                "More | User:%name% | Server:%serverip% | FPS:%fps%"
            else
                displayString.get()
    ...
    private fun getReplacement(str: String): String? {
        ...
        return when (str) {
            ...
            "clientCreator" -> LiquidBounce.CLIENT_CREATOR
            "name" -> LiquidBounce.data!!.userName
            "serverIp" -> MoreIRC.getServerIP()
...
//            "worldTime" -> return SessionUtils.getFormatWorldTime()
    ...
    override fun drawElement(): Border? {
        ...
        val mwc1 = Color(CustomColor.r.get(),CustomColor.g.get(),CustomColor.b.get()).rgb
        val mwc2 = Color(CustomColor.r2.get(),CustomColor.g2.get(),CustomColor.b2.get()).rgb
