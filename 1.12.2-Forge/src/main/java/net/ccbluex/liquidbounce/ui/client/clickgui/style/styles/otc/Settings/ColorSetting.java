...
import static net.ccbluex.liquidbounce.utils.render.RenderUtils.darker;
...
public class ColorSetting extends Downward<ColorValue> {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        //Value名字
        FontLoaders.C12.drawString(colorValue.getName(), modulex + 5 + pos.x + 4, moduley + 17 + colory + 12, new Color(200, 200, 200).getRGB());
        ...
        RenderUtils.drawGradientRect(x2, y2, x2 + width, y2 + height, newColor, darker(newColor, 0.6f));
        if (colorValue.isExpanded()) {
            ...
            RenderUtils.drawBorderedRect(expandedX, expandedY,expandedX + expandedWidth, expandedY+expandedHeight + 70,1, new Color(0,0,0,0).getRGB(),new Color(85,90,96).getRGB());
