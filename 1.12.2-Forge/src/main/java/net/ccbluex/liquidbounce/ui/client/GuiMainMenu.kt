...
class GuiMainMenu : WrappedGuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        RenderUtils.drawImage(classProvider.createResourceLocation("more/bg.png"), 0, 0, sr.scaledWidth, sr.scaledHeight)
      //  RoundedUtil.drawRound(representedScreen.width / 2 - 60F, defaultHeight - 30F, representedScreen.width / 2 - 50f , defaultHeight + 100F,CustomColor.ra.get(), Color(255, 255, 255, 50))
        Fonts.productSans70.drawCenteredStringWithShadow("More", sr.scaledWidth / 2F, defaultHeight.toFloat() - 30f, -1)
