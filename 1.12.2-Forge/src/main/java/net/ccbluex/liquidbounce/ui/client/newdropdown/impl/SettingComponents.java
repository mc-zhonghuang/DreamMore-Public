...
import net.ccbluex.liquidbounce.utils.LiYingUtil;
    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        for (Value setting : module.getValues()) {
            ...
            if (setting instanceof FloatValue) {
                ...
                RoundedUtil.drawRound(x + 5, sliderY, totalSliderWidth, 3, 1.5f, LiYingUtil.applyOpacity(darkRectHover, (float) (.4f + (.2 * hoverAnimation.getOutput()))));
