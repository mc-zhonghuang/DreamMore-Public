...
public class SlowlyStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        ...
        float textWidth = Fonts.roboto35.getStringWidth("§f" + StringUtils.stripControlCodes(panel.getName()));
        Fonts.roboto35.drawString(panel.getName(), (int) (panel.getX() - (textWidth - 100.0F) / 2F), panel.getY() + 7 - 3, Color.WHITE.getRGB());
    }

    @Override
    public void drawDescription(int mouseX, int mouseY, String text) {
        int textWidth = Fonts.roboto35.getStringWidth(text);

        RenderUtils.drawBorderedRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.roboto35.getFontHeight() + 3, 3F, new Color(42, 57, 79).getRGB(), new Color(42, 57, 79).getRGB());
        GlStateManager.resetColor();
        Fonts.roboto35.drawString(text, mouseX + 12, mouseY + (Fonts.roboto35.getFontHeight() / 2), Color.WHITE.getRGB());
    }
            ...
            if (moduleElement.isShowSettings()) {
                ...
                for (final Value value : moduleValues) {
                    ...
                    if (value instanceof BoolValue) {
                        ...
                        final float textWidth = Fonts.roboto35.getStringWidth(text);
                        ...
                        Fonts.roboto35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, ((BoolValue) value).get() ? Color.WHITE.getRGB() : Integer.MAX_VALUE);
                        ...
                        Fonts.roboto35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, 0xffffff);
                        Fonts.roboto35.drawString(listValue.openList ? "-" : "+", (int) (moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() - (listValue.openList ? 5 : 6)), moduleElement.slowlySettingsYPos + 2, 0xffffff);

                        if (mouseX >= moduleElement.getX() + moduleElement.getWidth() + 4 && mouseX <= moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() && mouseY >= moduleElement.slowlySettingsYPos && mouseY <= moduleElement.slowlySettingsYPos + Fonts.roboto35.getFontHeight() && Mouse.isButtonDown(0) && moduleElement.isntPressed()) {
                        ...
                        for (final String valueOfList : listValue.getValues()) {
                            final float textWidth2 = Fonts.roboto35.getStringWidth("> " + valueOfList);
                            ...
                            if (listValue.openList) {
                                ...
                                GlStateManager.resetColor();
                                Fonts.roboto35.drawString("> " + valueOfList, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, listValue.get() != null && listValue.get().equalsIgnoreCase(valueOfList) ? Color.WHITE.getRGB() : Integer.MAX_VALUE);
                                moduleElement.slowlySettingsYPos += Fonts.roboto35.getFontHeight() + 1;
                            }
                        }
                        ...
                        Fonts.roboto35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 3, 0xffffff);
                        ...
                        Fonts.roboto35.drawString(displayString, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, Color.WHITE.getRGB());
                        int stringWidth = Fonts.roboto35.getStringWidth(displayString);
                        ...
                        GlStateManager.resetColor();
                        Fonts.roboto35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 4, 0xffffff);
