...
class TabGUI(x: Double = 5.0, y: Double = 25.0) : Element(x = x, y = y) {
    ...
    private val fontValue = FontValue("Font", Fonts.roboto35)
    ...
    private inner class Tab(val tabName: String) {
        ...
        fun drawTab(x: Float, y: Float, color: Int, backgroundColor: Int, borderColor: Int, borderStrength: Float,
            ...
            for (module in modules)
                if (fontRenderer.getStringWidth(if (upperCase) module.spacedName.toUpperCase() else module.spacedName) + 4 > maxWidth)
                    maxWidth = (fontRenderer.getStringWidth(if (upperCase) module.spacedName.toUpperCase() else module.spacedName) + 7F).toInt()
            ...
            modules.forEachIndexed { index, module ->
                ...
                fontRenderer.drawString(if (upperCase) module.spacedName.toUpperCase() else module.name, x + 2F,
