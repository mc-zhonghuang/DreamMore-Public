...
public class MainScreen implements Screen {
    ...
    public void initGui() {
        if (moduleRects == null) {
            ...
            for (Module module : Main.getModulesInCategory(category,LiquidBounce.moduleManager).stream().sorted(Comparator.comparing(Module::getSpacedName)).collect(Collectors.toList())) {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        net.ccbluex.liquidbounce.ui.font.simple.impl.Fonts.SFBOLD.SFBOLD_26.SFBOLD_26.drawString(category.name(), x + 5, y + Fonts.SFBOLD.SFBOLD_26.SFBOLD_26.getMiddleOfBox(categoryRectHeight), textColor);
