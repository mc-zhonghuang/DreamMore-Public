...
class Effects(x: Double =97.0, y: Double = 141.0, scale: Float = 1F) : Element() {
    ...
    override fun drawElement(): Border {
        ...
        RoundedUtil.drawGradientRound(12.20f, -7.32f, easingwith, easinghealth,CustomColor.ra.get(), ColorUtil.applyOpacity(gradientColor4, .85f), gradientColor1, gradientColor3, gradientColor2)

        GlStateManager.popMatrix()
        FontLoaders.F18.drawStringWithShadow("Effects",17.07.toDouble(),-3.66.toDouble(),Color(255,255,255,255).rgb)
