...
public class GuiPortScanner extends WrappedGuiScreen {
    ...
    public void initGui() {
        ...
        hostField = classProvider.createGuiTextField(0, Fonts.roboto40, representedScreen.getWidth() / 2 - 100, 60, 200, 20);
        hostField.setFocused(true);
        hostField.setMaxStringLength(Integer.MAX_VALUE);
        hostField.setText("localhost");

        minPortField = classProvider.createGuiTextField(1, Fonts.roboto40, representedScreen.getHeight() / 2 - 100, 90, 90, 20);
        minPortField.setMaxStringLength(5);
        minPortField.setText(String.valueOf(1));

        maxPortField = classProvider.createGuiTextField(2, Fonts.roboto40, representedScreen.getWidth() / 2 + 10, 90, 90, 20);
        maxPortField.setMaxStringLength(5);
        maxPortField.setText(String.valueOf(65535));

        threadsField = classProvider.createGuiTextField(3, Fonts.roboto40, representedScreen.getWidth() / 2 - 100, 120, 200, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.roboto40.drawCenteredString("Port Scanner", representedScreen.getWidth() / 2.0f, 34, 0xffffff);
        Fonts.roboto35.drawCenteredString(running ? "§7" + checkedPort + " §8/ §7" + maxPort : status == null ? "" : status, representedScreen.getWidth() / 2.0f, representedScreen.getHeight() / 4.0f + 80, 0xffffff);
        ...
        synchronized (ports) {
            ...
            for (final Integer integer : ports) {
                Fonts.roboto35.drawString(String.valueOf(integer), 2, i, Color.WHITE.hashCode());
                i += Fonts.roboto35.getFontHeight();
            }
        }
