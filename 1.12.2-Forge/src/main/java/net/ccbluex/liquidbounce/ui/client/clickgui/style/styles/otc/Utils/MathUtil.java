...
public class MathUtil {
    ...
    public static double getBaseMovementSpeed() {
        ...
        if (Helper.mc.player.isPotionActive(MobEffects.SPEED)) {
            int amplifier = Helper.mc.player.getActivePotionEffect(MobEffects.SPEED).getAmplifier();
    ...
    public static double getHighestOffset(double max) {
        ...
        while (i < max) {
            ...
            while (n2 < n) {
                int offset = arrn2[n2];
                if (Helper.mc.world.getCollisionBoxes(Helper.mc.player, Helper.mc.player.getEntityBoundingBox().offset(Helper.mc.player.motionX * (double)offset, i, Helper.mc.player.motionZ * (double)offset)).size() > 0) {
                    return i - 0.01;
                }
                ++n2;
            }
