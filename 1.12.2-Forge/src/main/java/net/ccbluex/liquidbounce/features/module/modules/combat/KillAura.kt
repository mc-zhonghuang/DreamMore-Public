...
@ModuleInfo(
    ...
    category = ModuleCategory.COMBAT, keyBind = Keyboard.KEY_R, autoDisableMode = Module.AutoDisableMode.WORLDCHANGE
)
class KillAura : Module() {
    ...
    private val hiteffect = ListValue(
        "HitEffect",
        arrayOf("Lightningbolt", "Criticals", "Blood", "Fire", "Water", "Smoke", "Flame", "Heart", "None"),
        "Always"
    )
    ...
    fun onRender3D(event: Render3DEvent) {
        ...
        val ent =
            classProvider.createEntityLightningBolt(mc.theWorld!!, target!!.posX, target!!.posY, target!!.posZ, false)
    ...
    private fun changeRange(): Boolean {
        return beginValue.get() && LiquidBounce.moduleManager.getModule(NoC03s::class.java).state && !MovementUtils.isMoving
    }
    /**
     * HUD Tag
     */
