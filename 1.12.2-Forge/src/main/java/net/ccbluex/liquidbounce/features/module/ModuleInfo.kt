...
annotation class ModuleInfo(val name: String, val description: String, val category: ModuleCategory, val autoDisableMode: Module.AutoDisableMode = Module.AutoDisableMode.NONE,
