...
class Fly : Module() {
    ...
    private var lastPos: Vec3 = Vec3(0.0, 0.0, 0.0)
    ...
    override fun onEnable() {
        ...
        lastPos = Vec3(mc.thePlayer!!.posX, mc.thePlayer!!.posY, mc.thePlayer!!.posZ)
    ...
    override fun onDisable() {
        ...
        if (mode.equals("GrimAC", ignoreCase = true)) {
...
//                    mc.effectRenderer.spawnEffectParticle(EnumParticleTypes.FLAME.getParticleID(), thePlayer.posX, thePlayer.posY + 0.2, thePlayer.posZ, -thePlayer.motionX, -0.5, -thePlayer.motionZ)
    ...
    fun onPacket(event: PacketEvent) {
        ...
        if (modeValue.get().equals("GrimAC", ignoreCase = true)) {
            if (event.packet.unwrap() !is CPacketPlayerTryUseItemOnBlock) {
                event.cancelEvent()
            }
        }
    }
