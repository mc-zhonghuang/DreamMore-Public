...
@ModuleInfo("SpeedMine", description = "114514", category = ModuleCategory.WORLD)
class HYTSpeedMine : Module() {
    private val modeValue = ListValue("Mode", arrayOf("Hypixel", "Packet", "NewPacket", "NewPacket2", "Tenacity"),"NewPacket")
