...
import net.ccbluex.liquidbounce.rename.modules.player.AutoTool
...
//    private val hyttest = BoolValue("Hyttest", false)
...
//        val event = packetEvent.packet.unwrap()
//        if (hyttest.get()){
//            if (event is CPacketPlayer){
//                PacketUtils.handleSendPacket(CPacketPlayer())
//            }
//        }
//    }
