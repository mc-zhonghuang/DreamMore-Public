...
public class ValuesConfig extends FileConfig {
        ...
        for (Map.Entry<String, JsonElement> entry : jsonObject.entrySet()) {
            if (entry.getKey().equalsIgnoreCase("CommandPrefix")) {
                ...
                if (module != null) {
                    ...
                    if(jsonModule.has("AutoDisabled"))
                        module.setAutoDisableMode(Module.AutoDisableMode.valueOf(jsonModule.get("AutoDisabled").getAsString()));
    ...
    protected void saveConfig() throws IOException {
        ...
        LiquidBounce.moduleManager.getModules().forEach(module -> {
            ...
            jsonModule.addProperty("AutoDisabled", module.getAutoDisableMode().toString());
