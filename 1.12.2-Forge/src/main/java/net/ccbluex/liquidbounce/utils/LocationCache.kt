...
class LocationCache : MinecraftInstance(), Listenable {
    ...
    companion object {
        ...
        private val aabbList = HashMap<Int, SoftReference<RingBuffer<IAxisAlignedBB>>>(CACHE_SIZE)
        private val playerLocationList = RingBuffer<Location>(CACHE_SIZE)

        fun getPreviousAABB(entityId: Int, ticksBefore: Int, default: IAxisAlignedBB): IAxisAlignedBB {
