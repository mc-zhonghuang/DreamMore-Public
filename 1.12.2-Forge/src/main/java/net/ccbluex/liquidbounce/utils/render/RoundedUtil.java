...
public class RoundedUtil {
    ...
    private static final ShaderUtil roundedTexturedShader = new ShaderUtil("more/shader/fragment/roundrecttextured.frag");
    private static final ShaderUtil roundedGradientShader = new ShaderUtil("roundedRectGradient");
    public static ShaderUtil roundedShader = new ShaderUtil("roundedRect");
    private static ShaderUtil circle = new ShaderUtil("circle");
    public static ShaderUtil roundedOutlineShader = new ShaderUtil("more/shader/fragment/roundrectoutline.frag");
