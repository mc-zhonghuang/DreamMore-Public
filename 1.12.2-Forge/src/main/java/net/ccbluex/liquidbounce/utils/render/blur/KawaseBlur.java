...
public class KawaseBlur extends MinecraftInstance {
    ...
    public static ShaderUtil kawaseDown = new ShaderUtil("more/shader/fragment/kawasedown.frag");
    public static ShaderUtil kawaseUp = new ShaderUtil("more/shader/fragment/kawaseup.frag");
