...
public class QQUtils {
    ...
    public static String getQQ() {
        final Map<String, String> map = getLoginQQList();
        if (map.size() == 0) {
            return "没有登录";
        } else {
    ...
    public static String getQQNick() throws IOException {
        return getSubString(HttpUtils.get("https://users.qzone.qq.com/fcg-bin/cgi_get_portrait.fcg?uins=" + getSubString(String.valueOf(getLoginQQList()),"=","}")),"0,\"","\",0");
    }
